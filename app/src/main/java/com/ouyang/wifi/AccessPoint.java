...
class AccessPoint implements Comparable{
    ...
    private Context context;
     static final int[] STATE_SECURED = {
    ...
    AccessPoint(Context context, WifiConfiguration config,View view) {
        bindView=view;
    ...
    AccessPoint(Context context, ScanResult result,View view) {
        bindView=view;
        this.context=context;
        //    setWidgetLayoutResource(R.layout.preference_widget_wifi_signal);
        loadResult(result);
    ...
    AccessPoint(Context context, Bundle savedState,View view) {
        //  setWidgetLayoutResource(R.layout.preference_widget_wifi_signal);
        bindView=view;
        this.context=context;
    ...
    protected void onBindView() {
      ...
      //  ImageView signal = (ImageView) view.findViewById(R.id.signal);
        TextView ssidV= (TextView) bindView.findViewById(R.id.list_wifi_ssid);
        ImageView signal = (ImageView) bindView.findViewById(R.id.list_wifi_signal);
        signal.setImageLevel(getLevel());
        ImageView lockV= (ImageView)bindView.findViewById(R.id.list_wifi_lock);
        lockV.setImageState((security != AccessPoint.SECURITY_NONE) ?
    ...
    @Override
    public int compareTo(Object preference) {
    ...
    private void refresh() {
        ...
        if (mConfig != null && mConfig.status == WifiConfiguration.Status.DISABLED) {
            ...
            setSummary("out of range");
        } else if (mState != null) { // This is the active connection
            setSummary(Summary.get(context, mState));
            Log.i("ouyang"," ssid:"+ssid+"  state ordinal:"+mState.ordinal());
    ...
    private void setSummary(String msg){
        TextView stateText= (TextView) bindView.findViewById(R.id.list_wifi_state);
